...
from .models import AuditEvent, Batch, Product, SaleAdjustment, SaleItem, SaleRecord, Supplier, compute_batch_status
...
def product_edit_view(request, pk):
    ...
    # For AJAX form request, return just the form HTML
    if (
        ...
        form_html = render(
            request, "product_form_fields.html", {"form": form, "product": product}
        ).content.decode()
