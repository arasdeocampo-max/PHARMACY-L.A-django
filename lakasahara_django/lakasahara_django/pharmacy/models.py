...
class SaleRecord(models.Model):
    ...
    state = models.CharField(max_length=30, choices=STATE_CHOICES, default="completed")
...
class FinancialTransaction(models.Model):
    TYPE_CHOICES = [("sale", "Sale"), ("refund", "Refund"), ("void", "Void")]
    transaction_id = models.CharField(max_length=30, unique=True)
    sale = models.ForeignKey(SaleRecord, on_delete=models.PROTECT, related_name="financial_transactions")
    adjustment = models.OneToOneField(
        "SaleAdjustment", on_delete=models.PROTECT, null=True, blank=True, related_name="financial_transaction"
    )
...
class SaleAdjustment(models.Model):
    ...
    rejected_by = models.ForeignKey(
        User, on_delete=models.PROTECT, null=True, blank=True, related_name="rejected_sale_adjustments"
    )
